  ...
  return (
    <>
      ...
      <div className="topbar">
        <div className="topbar-inner">
          ...
          <span className="topbar-right">
            ...
            Call us at <span style={{ fontWeight: "800", marginLeft: '4px' }}>🇦🇪 +971 50 448 6285</span>
          </span>
        </div>
      </div>
        ...
        <div className="nav-inner">
          ...
          <div className="nav-right">
            <div className="nav-phone-pill" style={{ textDecoration: 'none' }}>
              <a style={{ color: '#ffffff', textDecoration: 'none' }}>🇦🇪 +971 50 448 6285</a>
            </div>
          </div>
      ...
      <div className={`mobile-sticky-bottom-bar ${isScrolled ? "visible" : ""}`}>
        ...
        <a href="https://wa.me/971504486285?text=Hello%20AD%20Firms%2C%20I%20would%20like%20to%20enquire%20about%20business%20setup%20services%20in%20Dubai%2C%20UAE.%20Please%20provide%20more%20details." className="mbtn-quote" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
          WhatsApp
          <span style={{ display: 'flex', alignItems: 'center', marginLeft: '6px', opacity: 1 }}>
